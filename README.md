...
[a conscious decision by the libfprint developers](https://gitlab.freedesktop.org/libfprint/fprintd/-/blob/244be2511f92f3de93ea8fb0b9df70a53f48169c/src/device.c#L2230).
...
This script uses the `PyGObject` library to interface with fprintd, and `PyGObject` has a number of build dependencies that
